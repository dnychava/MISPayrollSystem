...
/**
 * This class has the type's of record status.<BR><BR>
 * 1. Submitted <BR>
 * 2. Approved <BR> 
 * 3. Rejected <BR> 
 * 4. Submitted To Bank <BR> 
 * 5. Payment Credited <BR> 
 * 6. Payslip Sent <BR> 
 * 
...
public class RecordStatusEntity {
	 ...
	 */
	@Column(name = "RECORD_STATUS_NAME", unique = true, nullable = false, length = 50)
	private String name;
